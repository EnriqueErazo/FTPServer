...
#Region "VARIABLES"
	...
	Private Shared Clientes As New Hashtable()	'Aqui se guarda la informacion de todos los clientes conectados 
...
#Region "METODOS"
	...
	Public Sub Cerrar()
		...
		Next
	End Sub
	Public Shared Sub EnviarDatos(ByVal IDCliente As Net.IPEndPoint, ByVal Datos As String)
	...
	End Sub
	Public Shared Sub EnviarDatos(ByVal Datos As String)
		Dim cliente As InfoDeUnCliente
